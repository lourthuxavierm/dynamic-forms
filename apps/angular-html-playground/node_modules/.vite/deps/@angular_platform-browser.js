...
var SharedStylesHost = class SharedStylesHost {
	...
	addElement(host, element) {
		...
		if (typeof ngServerMode !== "undefined" && ngServerMode) element.setAttribute(APP_ID_ATTRIBUTE_NAME, this.appId);
...
var DomRendererFactory2 = class DomRendererFactory2 {
	...
	createRenderer(element, type) {
		...
		if (typeof ngServerMode !== "undefined" && ngServerMode && (type.encapsulation === ViewEncapsulation.ShadowDom || type.encapsulation === ViewEncapsulation.ExperimentalIsolatedShadowDom)) type = {
			...type,
...
var DefaultDomRenderer2 = class {
	...
	decoratePreventDefault(eventHandler) {
		return (event) => {
			...
			if ((typeof ngServerMode !== "undefined" && ngServerMode ? this.ngZone.runGuarded(() => eventHandler(event)) : eventHandler(event)) === false) event.preventDefault();
		};
	}
};
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+platform-browser@2_49839d027ab9cb794a33a6120b97830c/node_modules/@angular/platform-browser/fesm2022/_browser-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
async function bootstrapApplication(rootComponent, options, context) {
	...
	if ((typeof ngJitMode === "undefined" || ngJitMode) && typeof fetch === "function") await resolveJitResources();
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+common@22.1.3_@ang_437170b0066af5415e5c281f4c06bf57/node_modules/@angular/common/fesm2022/_module-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
var XSSI_PREFIX$1 = /^\)\]\}',?\n/;
var DEFAULT_SSR_MAX_RESPONSE_BODY_SIZE = 1048576;
var HTTP_FETCH_MAX_RESPONSE_SIZE = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "HTTP_FETCH_MAX_RESPONSE_SIZE" : "", { factory: () => typeof ngServerMode !== "undefined" && ngServerMode ? DEFAULT_SSR_MAX_RESPONSE_BODY_SIZE : null });
...
var HttpClient = class HttpClient {
	...
	request(first, url, options = {}) {
		...
		if (first instanceof HttpRequest) req = first;
			...
			let params = void 0;
			if (!!options.params) {
				if (options.params instanceof HttpParams) params = options.params;
...
var HttpXhrBackend = class HttpXhrBackend {
	...
	handle(req) {
		...
		return (typeof ngServerMode !== "undefined" && ngServerMode && xhrFactory.ɵloadImpl ? from(xhrFactory.ɵloadImpl()) : of(null)).pipe(switchMap(() => {
			return new Observable((observer) => {
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+common@22.1.3_@ang_437170b0066af5415e5c281f4c06bf57/node_modules/@angular/common/fesm2022/http.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
function retrieveStateFromCache(req, options, transferState, originMap, storeKey, skipUseCacheChecks = false) {
	...
	if (typeof ngServerMode !== "undefined" && !ngServerMode && originMap) throw new RuntimeError(2803, ngDevMode && "Angular detected that the `HTTP_TRANSFER_CACHE_ORIGIN_MAP` token is configured and present in the client side code. Please ensure that this token is only provided in the server code of the application.");
	if (!storeKey) storeKey = makeCacheKey(req, typeof ngServerMode !== "undefined" && ngServerMode && originMap ? mapRequestOriginUrl(req.url, originMap) : req.url);
...
function transferCacheInterceptorFn(req, next) {
	...
	if (typeof ngServerMode !== "undefined" && ngServerMode) return event$.pipe(tap((event) => {
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+platform-browser@2_49839d027ab9cb794a33a6120b97830c/node_modules/@angular/platform-browser/fesm2022/platform-browser.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
