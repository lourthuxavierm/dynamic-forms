...
//#endregion
//#region ../../node_modules/.pnpm/@angular+common@22.1.3_@ang_437170b0066af5415e5c281f4c06bf57/node_modules/@angular/common/fesm2022/_location-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+common@22.1.3_@ang_437170b0066af5415e5c281f4c06bf57/node_modules/@angular/common/fesm2022/_common_module-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
function roundNumber(parsedNumber, minFrac, maxFrac) {
	...
	const carry = digits.reduceRight(function(carry, d, i, digits) {
		...
		if (dropTrailingZeros) {
			if (digits[i] === 0 && i >= minLen) digits.pop();
	...
	ngDoCheck() {
		if (this._ngForOfDirty) {
			...
			if (!this._differ && value) {
				if (typeof ngDevMode === "undefined" || ngDevMode) try {
...
var CurrencyPipe = class CurrencyPipe {
	...
	transform(value, currencyCode = this._defaultCurrencyCode, display = "symbol", digitsInfo, locale) {
		...
		if (display !== "code") {
			if (display === "symbol" || display === "symbol-narrow") currency = getCurrencySymbol(currency, display === "symbol" ? "wide" : "narrow", locale);
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+common@22.1.3_@ang_437170b0066af5415e5c281f4c06bf57/node_modules/@angular/common/fesm2022/_platform_navigation-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+common@22.1.3_@ang_437170b0066af5415e5c281f4c06bf57/node_modules/@angular/common/fesm2022/_xhr-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+common@22.1.3_@ang_437170b0066af5415e5c281f4c06bf57/node_modules/@angular/common/fesm2022/common.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
var LCPImageObserver = class LCPImageObserver {
	...
	constructor() {
		...
		if ((typeof ngServerMode === "undefined" || !ngServerMode) && typeof PerformanceObserver !== "undefined") this.observer = this.initPerformanceObserver();
	}
...
var NgOptimizedImage = class NgOptimizedImage {
	...
	ngOnInit() {
		...
		if (ngDevMode) {
			...
			if (this.priority) {
				...
				if (typeof ngServerMode !== "undefined" && !ngServerMode) assetPriorityCountBelowThreshold(this.injector.get(ApplicationRef));
			}
		}
	...
	setHostAttributes() {
		...
		if (this.sizes) {
			if (this.getLoadingBehavior() === "lazy") this.setHostAttribute("sizes", "auto, " + this.sizes);
		...
		if (typeof ngServerMode !== "undefined" && ngServerMode && this.priority) this.injector.get(PreloadLinkCreator).createPreloadLinkTag(this.renderer, this.getRewrittenSrc(), rewrittenSrcset, this.sizes, this.imgElement.getAttribute("crossorigin"));
	}
	ngOnChanges(changes) {
		...
		if (ngDevMode && changes["placeholder"]?.currentValue && typeof ngServerMode !== "undefined" && !ngServerMode) assertPlaceholderDimensions(this, this.imgElement);
	}
	getAspectRatio() {
