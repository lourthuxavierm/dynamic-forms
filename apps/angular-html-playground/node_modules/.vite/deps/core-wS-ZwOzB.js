import { Un as BehaviorSubject, Wn as Subject, Yn as Observable, fn as map, rr as Subscription } from "./zipWith-C_9FaCDH.js";
//#region ../../node_modules/.pnpm/@angular+core@22.1.3_@angular+compiler@22.1.3_rxjs@7.8.2/node_modules/@angular/core/fesm2022/_effect-chunk.mjs
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+core@22.1.3_@angular+compiler@22.1.3_rxjs@7.8.2/node_modules/@angular/core/fesm2022/_not_found-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+core@22.1.3_@angular+compiler@22.1.3_rxjs@7.8.2/node_modules/@angular/core/fesm2022/_untracked-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+core@22.1.3_@angular+compiler@22.1.3_rxjs@7.8.2/node_modules/@angular/core/fesm2022/_weak_ref-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+core@22.1.3_@angular+compiler@22.1.3_rxjs@7.8.2/node_modules/@angular/core/fesm2022/primitives-signals.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+core@22.1.3_@angular+compiler@22.1.3_rxjs@7.8.2/node_modules/@angular/core/fesm2022/_pending_tasks-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
var TransferState = class TransferState {
	static ɵprov = /* @__PURE__ */ ɵɵdefineInjectable({
		...
		factory: () => {
			...
			if (typeof ngServerMode === "undefined" || !ngServerMode) transferState.store = retrieveTransferredState(inject(DOCUMENT$1), inject(APP_ID));
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+core@22.1.3_@angular+compiler@22.1.3_rxjs@7.8.2/node_modules/@angular/core/fesm2022/_attribute-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+core@22.1.3_@angular+compiler@22.1.3_rxjs@7.8.2/node_modules/@angular/core/fesm2022/_debug_node-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
function afterEveryRender(callbackOrSpec, options) {
	...
	const injector = options?.injector ?? inject(Injector);
	if (typeof ngServerMode !== "undefined" && ngServerMode) return NOOP_AFTER_RENDER_REF;
...
function shouldTriggerDeferBlock(triggerType, lView) {
	if (triggerType === 0 && typeof ngServerMode !== "undefined" && ngServerMode) return false;
...
function shouldAttachRegularTrigger(lView, tNode) {
	...
	if (typeof ngServerMode !== "undefined" && ngServerMode) return !incrementalHydrationEnabled || !_hasHydrateTriggers;
...
function ɵɵdefer(index, primaryTmplIndex, dependencyResolverFn, loadingTmplIndex, placeholderTmplIndex, errorTmplIndex, loadingConfigIndex, placeholderConfigIndex, enableTimerScheduling, flags) {
	...
	if (tView.firstCreatePass) {
		...
		if (ngDevMode) {
			if (typeof ngHmrMode !== "undefined" && ngHmrMode) logHmrWarning(injector);
...
function ɵɵdeferHydrateWhen(rawValue) {
	...
	if (bindingUpdated(lView, bindingIndex, rawValue)) {
		if (typeof ngServerMode !== "undefined" && ngServerMode) triggerDeferBlock(2, lView, tNode);
		else {
			const injector = lView[9];
			const prevConsumer = setActiveConsumer(null);
			try {
...
function ɵɵdeferHydrateOnIdle(timeout) {
	...
	if (typeof ngServerMode !== "undefined" && ngServerMode) triggerDeferBlock(2, lView, tNode);
	else scheduleDelayedHydrating(onIdleWrapper({ timeout }), lView, tNode);
}
...
function ɵɵdeferHydrateOnTimer(delay) {
	...
	if (typeof ngServerMode !== "undefined" && ngServerMode) triggerDeferBlock(2, lView, tNode);
	else scheduleDelayedHydrating(onTimer(delay), lView, tNode);
}
function ɵɵdeferOnHover(triggerIndex, walkUpTimes) {
	...
	if (!shouldAttachTrigger(0, lView, tNode)) return;
	renderPlaceholder(lView, tNode);
	if (!(typeof ngServerMode !== "undefined" && ngServerMode)) registerDomTrigger(lView, tNode, triggerIndex, walkUpTimes, onHover, () => triggerDeferBlock(0, lView, tNode), 0);
}
...
function ɵɵdeferOnInteraction(triggerIndex, walkUpTimes) {
	...
	if (!shouldAttachTrigger(0, lView, tNode)) return;
	renderPlaceholder(lView, tNode);
	if (!(typeof ngServerMode !== "undefined" && ngServerMode)) registerDomTrigger(lView, tNode, triggerIndex, walkUpTimes, onInteraction, () => triggerDeferBlock(0, lView, tNode), 0);
}
...
function ɵɵdeferOnViewport(triggerIndex, walkUpTimes, options) {
	...
	if (!shouldAttachTrigger(0, lView, tNode)) return;
	renderPlaceholder(lView, tNode);
	if (!(typeof ngServerMode !== "undefined" && ngServerMode)) registerDomTrigger(lView, tNode, triggerIndex, walkUpTimes, onViewportWrapper, () => triggerDeferBlock(0, lView, tNode), 0, options);
}
...
function ɵɵanimateEnter(value) {
	...
	if (typeof ngServerMode !== "undefined" && ngServerMode || !areAnimationSupported) return ɵɵanimateEnter;
...
function ɵɵanimateEnterListener(value) {
	performanceMarkFeature("NgAnimateEnter");
	if (typeof ngServerMode !== "undefined" && ngServerMode || !areAnimationSupported) return ɵɵanimateEnterListener;
	ngDevMode && assertAnimationTypes(value, "animate.enter");
	const lView = getLView();
...
function ɵɵanimateLeave(value) {
	...
	if (typeof ngServerMode !== "undefined" && ngServerMode || !areAnimationSupported) return ɵɵanimateLeave;
...
function ɵɵanimateLeaveListener(value) {
	performanceMarkFeature("NgAnimateLeave");
	if (typeof ngServerMode !== "undefined" && ngServerMode || !areAnimationSupported) return ɵɵanimateLeaveListener;
	ngDevMode && assertAnimationTypes(value, "animate.leave");
	const lView = getLView();
	const tNode = getCurrentTNode();
	allLeavingAnimations.add(lView[19]);
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+core@22.1.3_@angular+compiler@22.1.3_rxjs@7.8.2/node_modules/@angular/core/fesm2022/_resource-chunk.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
	...
	async loadEffect() {
		...
		try {
			...
			if (isSignal(stream)) {
				...
				if (typeof ngServerMode !== "undefined" && ngServerMode) saveToTransferState(result, this.transferCacheKey, this.transferState);
			} else {
				...
				const result = resolvedStream ? untracked(resolvedStream) : void 0;
				if (typeof ngServerMode !== "undefined" && ngServerMode) saveToTransferState(result, this.transferCacheKey, this.transferState);
			}
		} catch (err) {
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+core@22.1.3_@angular+compiler@22.1.3_rxjs@7.8.2/node_modules/@angular/core/fesm2022/primitives-event-dispatch.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
//#endregion
//#region ../../node_modules/.pnpm/@angular+core@22.1.3_@angular+compiler@22.1.3_rxjs@7.8.2/node_modules/@angular/core/fesm2022/core.mjs
/**
* @license Angular v22.1.3
* (c) 2010-2026 Google LLC. https://angular.dev/
* License: MIT
...
function withEventReplay() {
	...
	if (typeof ngServerMode === "undefined" || !ngServerMode) providers.push({
		provide: ENVIRONMENT_INITIALIZER,
		useValue: () => {
		...
		useFactory: () => {
			...
			return () => {
				...
				appRef.onDestroy(() => {
					...
					if (typeof ngServerMode !== "undefined" && !ngServerMode) clearAppScopedEarlyEventContract(appId);
				});
...
function isClientRenderModeEnabled(doc) {
	return (typeof ngServerMode === "undefined" || !ngServerMode) && doc.body.hasAttribute("ngcm");
}
function withDomHydration() {
	const providers = [{
		...
		useFactory: () => {
			let isEnabled = true;
			if (typeof ngServerMode === "undefined" || !ngServerMode) isEnabled = !!inject(TransferState, { optional: true })?.get(NGH_DATA_KEY, null);
...
function compileNgModuleFactory(injector, options, moduleType) {
	...
	const resourceLoader = Injector.create({ providers: compilerProviders }).get(compiler.ResourceLoader);
	return resolveComponentResources((url) => Promise.resolve(resourceLoader.get(url))).then(() => moduleFactory);
}
function _lastDefined(args) {
	for (let i = args.length - 1; i >= 0; i--) if (args[i] !== void 0) return args[i];
}
var SCAN_DELAY = 200;
...
var ImagePerformanceWarning = class ImagePerformanceWarning {
	...
	lcpImageUrl;
	start() {
		if (typeof ngServerMode !== "undefined" && ngServerMode || typeof PerformanceObserver === "undefined" || this.options?.disableImageSizeWarning && this.options?.disableImageLazyLoadWarning) return;
...
function getPlatform() {
	if (typeof ngServerMode !== "undefined" && ngServerMode) return null;
...
function createOrReusePlatformInjector(providers = []) {
	...
	if (typeof ngServerMode === "undefined" || !ngServerMode) _platformInjector = injector;
	publishSignalConfiguration();
	runPlatformInitializers(injector);
	return injector;
}
...
function internalCreateApplication(config) {
	...
	if (typeof ngServerMode !== "undefined" && ngServerMode && !platformRef) throw new RuntimeError(-401, ngDevMode && "Missing Platform: This may be due to using `bootstrapApplication` on the server without passing a `BootstrapContext`. Please make sure that `bootstrapApplication` is called with a `context` argument.");
	try {
