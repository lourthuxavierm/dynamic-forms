        ...
        transform: {
            ...
            async handler(code, id) {
                ...
                if (!angularPackage) {
                    ...
                    return {
                        code: isProd && !preserveVendorMaps
                ...
                const result = await javascriptTransformer.transformData(cleanId, code, false, sideEffects);
                return {
