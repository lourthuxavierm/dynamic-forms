...
export declare function createFsWatcherCacheInvalidator(invalidateFsCaches: () => void, invalidateTsconfigCaches: () => void, performCompilation: () => Promise<void>, includeGlobs?: string[], debounceMs?: number): (file: string) => void;
/**
 ...
 */
export declare function groupDiagnosticsByFile(diagnostics: {
 ...
 */
export declare function collectEmittedDiagnostics(outputFiles: Map<string, EmitFileResult>): {
    errors: string[];
    warnings: string[];
};
/**
 ...
 */
export declare function formatDiagnosticWithLocation(diagnostic: ts.Diagnostic): string;
/**
 ...
 */
export declare function isAngularCompilationFile(code: string, hasEmittedContent: boolean): boolean;
/**
