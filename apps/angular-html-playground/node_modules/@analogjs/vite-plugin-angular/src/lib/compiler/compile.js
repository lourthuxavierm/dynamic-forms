                    ...
                    if (!isPartial && mightBeNonStandalone && registry) {
                        ...
                        if (owningModule) {
                            ...
                            for (const name of scopeNames) {
                                if (seenDeclarationNames.has(name))
                                    continue;
                                const entry = registry.get(name);
                                if (!entry ||
                                    entry.kind === 'ngmodule' ||
                                ...
                                if (!importedNames.has(name)) {
                                    ...
                                    if (spec)
                                        syntheticImports.set(name, spec);
                                }
                                ...
                                if (entry.inputs) {
                                    decl.inputs = Object.values(entry.inputs).map((i) => i.bindingPropertyName);
                                }
                                if (entry.outputs) {
                                    decl.outputs = Object.values(entry.outputs);
                                }
