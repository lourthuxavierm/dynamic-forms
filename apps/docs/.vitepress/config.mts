...
import { phase16Sidebar } from './phase16-navigation.mjs';
import { zodSidebar } from './zod-navigation.mjs';
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [zodSidebar, phase16Sidebar, phase15Sidebar, phase14Sidebar, phase13Sidebar, phase11Sidebar, ...phase1Sidebar],
