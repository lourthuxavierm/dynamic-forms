...
| `@dynamic-forms/zod` | Experimental | Form and field validators, pinned dual-major CI matrix, integration guide, and generated API reference; migration guidance and release gate pending |
