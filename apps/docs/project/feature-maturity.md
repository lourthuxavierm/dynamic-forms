...
| `@dynamic-forms/zod` | Experimental | Form and field validators, pinned dual-major CI matrix, and framework integration guide; API reference, migration guidance, and release gate pending |
