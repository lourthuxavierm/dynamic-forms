...
if (angularPackage.name !== '@dynamic-form-engine/angular') failures.push('Angular adapter package has the wrong name');
if (htmlPackage.name !== '@dynamic-form-engine/angular-html') failures.push('Angular HTML package has the wrong name');
