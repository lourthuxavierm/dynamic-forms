...
export interface BasicFormValues extends Record<string, unknown> { fullName: string; email: string; age: number | ''; department: string; acceptTerms: boolean; startDate: string; }
