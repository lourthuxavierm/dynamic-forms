...
export type FieldType = 'text' | 'textarea' | 'password' | 'email' | 'url' | 'number' | 'integer' | 'decimal' | 'hidden' | 'select' | 'multi-select' | 'autocomplete' | 'async-autocomplete' | 'checkbox' | 'checkbox-group' | 'radio' | 'radio-group' | 'switch' | 'toggle-button' | 'toggle-button-group' | 'tree-select' | 'tree-checkbox' | 'date' | 'time' | 'datetime' | 'date-range' | 'time-range' | 'datetime-range' | 'month' | 'year' | 'currency' | 'percentage' | 'slider' | 'range-slider' | 'rating' | 'phone' | 'otp' | 'pin' | 'mask' | 'file' | 'multi-file' | 'camera' | 'signature' | 'document-preview' | 'object' | 'array';
...
export type FieldConfig = TextFieldConfig | NumericFieldConfig | CurrencyFieldConfig | ChoiceFieldConfig | DateTimeFieldConfig | MaskFieldConfig | SegmentedFieldConfig | YearFieldConfig | RangeFieldConfig | ArrayFieldConfig | FileFieldConfig | Record<string, unknown>;
 ...
 */
export type InferSchemaType<T extends FormSchema | readonly FieldSchema[]> = T extends FormSchema ? InferFieldsType<T['fields']> : T extends readonly FieldSchema[] ? InferFieldsType<T> : never;
type InferFieldsType<T extends readonly FieldSchema[]> = {
    [K in T[number] as K['name']]: InferFieldType<K>;
};
type InferFieldType<T extends FieldSchema> = T['type'] extends 'object' ? T['fields'] extends readonly FieldSchema[] ? InferFieldsType<T['fields']> : Record<string, any> : T['type'] extends 'array' ? T['fields'] extends readonly FieldSchema[] ? InferFieldsType<T['fields']>[] : any[] : T['type'] extends 'number' | 'integer' | 'decimal' ? number : T['type'] extends 'checkbox' | 'switch' ? boolean : T['type'] extends 'multi-select' | 'checkbox-group' | 'toggle-button-group' ? any[] : any;
export {};
