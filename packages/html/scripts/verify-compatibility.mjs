...
for (const subpath of runtimeSubpaths) {
  ...
  const compatibilitySpecifier = `@dynamic-forms/html${suffix}`;
  const canonicalSpecifier = `@dynamic-forms/react-html${suffix}`;
...
assert.equal(stylesheet, "@import '@dynamic-forms/react-html/styles.css';");
