...
if (angular.name !== '@dynamic-forms/angular' || html.name !== '@dynamic-forms/angular-html') failures.push('Angular package names mismatch');
if (angular.dependencies?.['@dynamic-forms/core'] !== 'workspace:*') failures.push('Angular adapter must depend on Core');
if (html.dependencies?.['@dynamic-forms/angular'] !== 'workspace:*') failures.push('Angular HTML must depend on Angular adapter');
if (angular.dependencies?.['@dynamic-forms/angular-html']) failures.push('headless Angular must not depend on Angular HTML');
...
if (playground.dependencies?.['@dynamic-forms/angular-html'] !== 'workspace:*') failures.push('playground workspace dependency missing');

for (const artifact of [
  'packages/angular/dist/fesm2022/dynamic-forms-angular.mjs',
  'packages/angular/dist/types/dynamic-forms-angular.d.ts',
  'packages/angular-html/dist/fesm2022/dynamic-forms-angular-html.mjs',
  'packages/angular-html/dist/types/dynamic-forms-angular-html.d.ts',
